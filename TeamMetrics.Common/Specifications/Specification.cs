...
public abstract class Specification<T> where T : class {
    ...
    public abstract Expression<Func<T, Boolean>> Rule();
    ...
    public Specification<T> And(Specification<T> specification) {
        ...
        if (specification == identification) {
            return this;
        }
    ...
    public Specification<T> Or(Specification<T> specification) {
        if (this == identification || specification == identification) {
...
internal sealed class SpecificationIdentification<T> : Specification<T> where T : class {
    public override Expression<Func<T, Boolean>> Rule() {
        return x => true;
    }
}
...
internal sealed class SpecificationAnd<T> : Specification<T> where T : class {
    ...
    public override Expression<Func<T, Boolean>> Rule() {
        ...
        var lambda = Expression.Lambda<Func<T, Boolean>>(body, parameter);
        return lambda;
    }
}
